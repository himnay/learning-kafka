...
## <span style="color:hsl(230,80%,58%)">Modules</span>
...
### <span style="color:hsl(282,80%,58%)">Producer reliability configuration (`application.yml`, `local` profile)</span>
...
## <span style="color:hsl(60,80%,50%)">Consumer side: `LibraryEventsConsumer` → `LibraryEventsService`</span>
...
## <span style="color:hsl(112,80%,58%)">Delivery semantics in this module, concretely</span>
...
## <span style="color:hsl(250,80%,58%)">Running just this module</span>
...
### <span style="color:hsl(27,80%,58%)">Inspecting the dead-letter topic</span>

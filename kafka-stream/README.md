# <span style="color:hsl(69,80%,50%)">kafka-stream — Orders Count & Revenue Topology</span>
...
## <span style="color:hsl(207,80%,58%)">Modules</span>
...
## <span style="color:hsl(344,80%,58%)">Why Kafka Streams — stream processing vs. request/reply</span>
...
### <span style="color:hsl(259,80%,58%)">The four materialized state stores</span>
...
### <span style="color:hsl(37,80%,58%)">What `OrdersTopologyTest` actually verifies</span>
...
## <span style="color:hsl(174,80%,58%)">Error handling: three independent handlers for three independent failure modes</span>
...
## <span style="color:hsl(312,80%,58%)">Interactive queries: `OrderStoreService` + `OrdersController`</span>
...
## <span style="color:hsl(89,80%,58%)">Running just this module</span>
...
### <span style="color:hsl(227,80%,58%)">Tests</span>
